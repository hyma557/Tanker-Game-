...
function setup(){
 ...
 bg = createSprite(width / 2, height / 2)
  ...
  tank2.debug = false
   ...
   medkit.setCollider("rectangle",0,0,tank1.width-700,tank1.height-200);
   medkit.debug = false
   medkit1.setCollider("rectangle",0,0,tank2.width-700,tank2.height-200);
   medkit1.debug = false
   ...
   //ok = createButton(width/2+400, height-200, 100, 10)
